# Generated by Powerlevel10k configuration wizard on 2021-04-23 at 02:06 JST.
...
# 12h time, slanted separators, round heads, round tails, 2 lines, disconnected,
# no frame, compact, many icons, concise, instant_prompt=verbose.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=30 # 255
  # Custom icon.
